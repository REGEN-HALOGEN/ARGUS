            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-4">
                  <span
                    className={`inline-flex items-center rounded-md px-2 py-0.5 text-[10px] font-semibold uppercase ring-1 ${sophBadge(actor.sophistication)}`}
                  >
                            ...
                            <div className="space-y-2">
                              {actor.cves.slice(0, 5).map((c, idx) => (
                                ...
                                >
                                  ...
                                  <span
                                    className={`text-[10px] px-2 py-1 rounded font-bold uppercase tracking-wider ${c.severity === 'critical' ? 'bg-threat-500/15 text-threat-400' : 'bg-warning-500/15 text-warning-400'}`}
                                  >
                                    CVSS {c.cvss}
                                  </span>
                                </div>
