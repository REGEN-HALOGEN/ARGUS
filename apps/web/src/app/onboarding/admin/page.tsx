    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="glass-card w-full max-w-md p-8 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8 relative z-10">
          ...
          <h1 className="text-2xl font-bold text-foreground tracking-tight">ARGUS Admin Access</h1>
          <p className="text-sm text-muted-foreground mt-1">
            Use the admin credentials to continue
          </p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4 relative z-10">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl bg-card/40 px-4 py-3 text-sm text-foreground ring-1 border border-card-border focus:outline-none focus:ring-primary-500/50 placeholder:text-muted-foreground/50 transition-all"
